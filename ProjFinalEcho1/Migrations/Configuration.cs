namespace ProjFinalEcho1.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ProjFinalEcho1.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ProjFinalEcho1.Models.ApplicationDbContext context)
        {
            ...
            new Comentarios {ID=1, Coment="coment 1" ,DataDoComentario = new DateTime(2019,3,15), PostId=2},
            new Comentarios {ID=2, Coment="coment 2" ,DataDoComentario = new DateTime(2019,3,15), PostId=2},
            new Comentarios {ID=3, Coment="coment 3" ,DataDoComentario = new DateTime(2019,3,15), PostId=3},};
            ...
            new Votes {ID=1,PostId=2},
            new Votes {ID=2, PostId=2},
            new Votes {ID=3, PostId=3},};
